...
//const static char* dataset_images_location = "/home/matheus-ubuntu/Desktop/sequences/00/image_1";
 const static char* dataset_images_location = "/home/matheus-ubuntu/Desktop/circulo_10";
...
int main(int argc, char** argv) {
  ...
  for(int numFrame=first_image+2; numFrame < MAX_FRAME; numFrame++) {
    ...
    if(numFrame==265){
      ...
      color_blue=255;
      color_green=255;
    }else if(numFrame==484){
          t_f=0;
      color_red=255; //red
      color_blue=0;
      color_green=0;
    }else if(numFrame==697){
          t_f=0;
      color_red=0; //blue
      color_blue=255;
      color_green=0;
    }
    else if(numFrame==914){
          t_f=0;
      color_red=255; //yellow
      color_blue=0;
      color_green=255;
    }
    else if(numFrame==1116){
          t_f=0;
      color_red=0; //cyan
      color_blue=255;
      color_green=255;
    ...
    else if(numFrame==1535){
          t_f=0;
      color_red=192; //silver
      color_blue=192;
      color_green=192;
    }
    else if(numFrame==1740){
          t_f=0;
      color_red=128; //olive
      color_blue=0;
      color_green=128;
    }
    else if(numFrame==1948){
          t_f=0;
      color_red=0; //Teal
      color_blue=128;
      color_green=128;
