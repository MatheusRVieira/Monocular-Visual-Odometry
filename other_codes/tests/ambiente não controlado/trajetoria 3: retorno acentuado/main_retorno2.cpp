...
//const static char* dataset_images_location = "/home/matheus-ubuntu/Desktop/sequences/00/image_1";
 const static char* dataset_images_location = "/home/matheus-ubuntu/Desktop/retorno2";
...
*/
    ...
    int x = int(t_f.at<double>(0))*1 + 800; //coordenadas do ponto inicial x e y na visualização
    int y = int(t_f.at<double>(2))*1 +200;
    //cout<<"x: "<<x<<" e y: "<<y<<endl;
